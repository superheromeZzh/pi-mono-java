...
class BedrockProviderTest {
    ...
    class ToolConversion {
        ...
        void convertsToolWithSchema() {
            ...
            var tool = new com.huawei.hicampus.campusclaw.ai.types.Tool("read", "Read a file", params);
        ...
        void convertsMultipleTools() {
            ObjectNode params = MAPPER.createObjectNode();
            var tools = List.of(
                    new com.huawei.hicampus.campusclaw.ai.types.Tool("read", "Read file", params),
                    new com.huawei.hicampus.campusclaw.ai.types.Tool("write", "Write file", params)
            );
        ...
        void handlesNullParameters() {
            var tool = new com.huawei.hicampus.campusclaw.ai.types.Tool("bash", "Run command", null);
            var result = BedrockProvider.convertTools(List.of(tool));
    ...
    class ParameterBuilding {
        ...
        void setsToolsWhenPresent() {
            ...
            var tools = List.of(new com.huawei.hicampus.campusclaw.ai.types.Tool("bash", "Run commands", toolParams));
            var context = new Context(null,
