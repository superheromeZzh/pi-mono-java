...
import com.huawei.hicampus.campusclaw.agent.Agent;
...
import com.huawei.hicampus.campusclaw.codingagent.command.builtin.HelpCommand;
import com.huawei.hicampus.campusclaw.codingagent.command.builtin.QuitCommand;
import com.huawei.hicampus.campusclaw.codingagent.session.AgentSession;
import com.huawei.hicampus.campusclaw.codingagent.skill.SkillRegistry;
import com.huawei.hicampus.campusclaw.codingagent.tool.bash.BashExecutor;
import com.huawei.hicampus.campusclaw.tui.terminal.TestTerminal;
...
class InteractiveModeTest {
    ...
    class EventHandling {
        ...
        void textDeltaUpdatesAssistantComponent() {
            ...
            var component = new com.huawei.hicampus.campusclaw.codingagent.mode.tui.AssistantMessageComponent();
        ...
        void toolStatusShowsRunningThenDone() {
            var tool = new com.huawei.hicampus.campusclaw.codingagent.mode.tui.ToolStatusComponent("bash");
    ...
    class FooterTests {
        ...
        void rendersModelInfo() {
            var footer = new com.huawei.hicampus.campusclaw.codingagent.mode.tui.FooterComponent();
        ...
        void tokenFormattingMillions() {
            assertEquals("1.5M", com.huawei.hicampus.campusclaw.codingagent.mode.tui.FooterComponent.formatTokens(1500000));
            assertEquals("15M", com.huawei.hicampus.campusclaw.codingagent.mode.tui.FooterComponent.formatTokens(15000000));
            assertEquals("200k", com.huawei.hicampus.campusclaw.codingagent.mode.tui.FooterComponent.formatTokens(200000));
            assertEquals("1.5k", com.huawei.hicampus.campusclaw.codingagent.mode.tui.FooterComponent.formatTokens(1500));
            assertEquals("500", com.huawei.hicampus.campusclaw.codingagent.mode.tui.FooterComponent.formatTokens(500));
        }
    }
    ...
    class BashExecutionTests {
        ...
        void rendersCommandAndOutput() {
            var comp = new com.huawei.hicampus.campusclaw.codingagent.mode.tui.BashExecutionComponent("ls -la", false);
        ...
        void excludedCommandShowsDollarDollar() {
            var comp = new com.huawei.hicampus.campusclaw.codingagent.mode.tui.BashExecutionComponent("pwd", true);
        ...
        void showsExitCodeOnError() {
            var comp = new com.huawei.hicampus.campusclaw.codingagent.mode.tui.BashExecutionComponent("bad-cmd", false);
        ...
        void showsRunningWhenIncomplete() {
            var comp = new com.huawei.hicampus.campusclaw.codingagent.mode.tui.BashExecutionComponent("sleep 10", false);
            var lines = comp.render(80);
            String output = String.join("\n", lines);
