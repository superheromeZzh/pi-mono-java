package com.huawei.hicampus.campusclaw.tui.component;
...
class SelectListTest {
    ...
    class Truncation {
        ...
        void longLabelIsTruncatedToFitWidth() {
            ...
            int visWidth = com.huawei.hicampus.campusclaw.tui.ansi.AnsiUtils.visibleWidth(line);
    ...
    class EdgeCases {
        ...
        void veryNarrowWidthStillRenders() {
            ...
            int visWidth = com.huawei.hicampus.campusclaw.tui.ansi.AnsiUtils.visibleWidth(lines.get(0));
