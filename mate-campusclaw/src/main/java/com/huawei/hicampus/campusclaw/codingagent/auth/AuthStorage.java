package com.huawei.hicampus.campusclaw.codingagent.auth;
...
public class AuthStorage {
    ...
    private static final Path AUTH_FILE = com.huawei.hicampus.campusclaw.codingagent.config.AppPaths.AUTH_FILE;
