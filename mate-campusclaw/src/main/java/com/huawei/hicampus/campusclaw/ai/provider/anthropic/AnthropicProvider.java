package com.huawei.hicampus.campusclaw.ai.provider.anthropic;
...
import com.huawei.hicampus.campusclaw.ai.types.ThinkingBudgets;
...
import com.huawei.hicampus.campusclaw.ai.types.Tool;
...
public class AnthropicProvider implements ApiProvider {
    ...
    static List<MessageParam> convertMessages(List<Message> messages, boolean enableCaching) {
        ...
        for (Message message : messages) {
            if (message instanceof com.huawei.hicampus.campusclaw.ai.types.UserMessage um) {
                result.add(convertUserMessage(um));
            } else if (message instanceof AssistantMessage am) {
                result.add(convertAssistantMessage(am));
            } else if (message instanceof com.huawei.hicampus.campusclaw.ai.types.ToolResultMessage tr) {
    ...
    private static MessageParam convertUserMessage(com.huawei.hicampus.campusclaw.ai.types.UserMessage um) {
    ...
    private static MessageParam convertToolResult(com.huawei.hicampus.campusclaw.ai.types.ToolResultMessage tr) {
