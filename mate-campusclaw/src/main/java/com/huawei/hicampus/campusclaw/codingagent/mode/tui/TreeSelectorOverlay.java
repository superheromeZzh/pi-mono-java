package com.huawei.hicampus.campusclaw.codingagent.mode.tui;
...
import com.huawei.hicampus.campusclaw.tui.Focusable;
import com.huawei.hicampus.campusclaw.tui.component.SelectList;
...
public class TreeSelectorOverlay implements Component, Focusable {
    ...
    public TreeSelectorOverlay(List<com.huawei.hicampus.campusclaw.ai.types.Message> messages) {
    ...
    private List<TreeItem> buildItems(List<com.huawei.hicampus.campusclaw.ai.types.Message> messages) {
