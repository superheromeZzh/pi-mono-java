package com.huawei.hicampus.campusclaw.ai.provider.google;
...
public class GoogleVertexAIProvider implements ApiProvider {
                    ...
                    for (var block : parsed.blocks()) {
                        if (block instanceof ThinkingContent tc) {
                            if (!"thinking".equals(currentType[0])) {
                                ...
                                eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.ThinkingStartEvent(
                            ...
                            eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.ThinkingDeltaEvent(
                            ...
                            if (!"text".equals(currentType[0])) {
                                ...
                                eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.TextStartEvent(
                                    blocks.size() - 1, buildMessage(model, blocks, usage[0], stop[0])));
                            }
                            ...
                            eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.ToolCallStartEvent(
                                idx, buildMessage(model, blocks, usage[0], stop[0])));
                            try {
                                eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.ToolCallDeltaEvent(
                                    idx, MAPPER.writeValueAsString(tc.arguments()), buildMessage(model, blocks, usage[0], stop[0])));
                            } catch (Exception ignored) {}
                            eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.ToolCallEndEvent(
    ...
    private void finishCurrentBlock(
        ...
        if ("thinking".equals(type)) {
            ...
            eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.ThinkingEndEvent(
            ...
            eventStream.push(new com.huawei.hicampus.campusclaw.ai.stream.AssistantMessageEvent.TextEndEvent(
                idx, content, buildMessage(model, blocks, usage, stop)));
        }
    }
