package com.huawei.hicampus.campusclaw.ai.provider.openai;
...
public class OpenAIResponsesProvider implements ApiProvider {
    ...
    private static String mapReasoningEffort(com.huawei.hicampus.campusclaw.ai.types.ThinkingLevel level) {
        return switch (level) {
            case MINIMAL -> "low";
            case LOW -> "low";
            case MEDIUM -> "medium";
