package com.huawei.hicampus.campusclaw.codingagent.diagnostic;
...
public class Diagnostics {
    ...
    private List<DiagnosticResult> checkConfigFiles(Path projectDir) {
        var results = new ArrayList<DiagnosticResult>();
        // Global config
        Path globalDir = com.huawei.hicampus.campusclaw.codingagent.config.AppPaths.USER_AGENT_DIR;
        ...
        // Project config
        Path projectConfig = projectDir.resolve(com.huawei.hicampus.campusclaw.codingagent.config.AppPaths.CONFIG_DIR_NAME);
