package com.huawei.hicampus.campusclaw.codingagent.keybinding;
...
public class KeyBindingRegistry {
    ...
    private static final Path KEYBINDINGS_FILE = com.huawei.hicampus.campusclaw.codingagent.config.AppPaths.KEYBINDINGS_FILE;
