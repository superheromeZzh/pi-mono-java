...
import com.mariozechner.pi.ai.provider.MockApiProvider;
...
class PiAiServiceTest {
    ...
    private PiAiService service;

    @BeforeEach
    void setUp() {
        providerRegistry = new ApiProviderRegistry(null);
        modelRegistry = new ModelRegistry();
        service = new PiAiService(providerRegistry, modelRegistry);
    }
    ...
    class Construction {
        ...
        void rejectsNullProviderRegistry() {
            assertThrows(NullPointerException.class,
                () -> new PiAiService(null, modelRegistry));
        }

        @Test
        void rejectsNullModelRegistry() {
            assertThrows(NullPointerException.class,
                () -> new PiAiService(providerRegistry, null));
        }
